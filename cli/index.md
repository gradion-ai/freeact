...
This requires an embedding API. The default configuration uses Gemini embeddings, which requires setting `GEMINI_API_KEY`. See [Hybrid Search Configuration](https://gradion-ai.github.io/freeact/configuration/#hybrid-search) for environment variables and customization options.
