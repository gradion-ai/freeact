...
Freeact supports any model compatible with [Pydantic AI](https://ai.pydantic.dev/models/). The model is configured in [`.freeact/config.json`](https://gradion-ai.github.io/freeact/configuration/#configuration-file) through three settings:
