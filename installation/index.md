...
Freeact uses `google-gla:gemini-3-flash-preview` as the [default model](https://gradion-ai.github.io/freeact/models/index.md). Set the API key in your environment:
