...
| **Sandbox mode** | Code actions execute locally in a stateful IPython kernel via [ipybox](https://gradion-ai.github.io/ipybox/). An optional [sandbox mode](sandbox.md) restricts filesystem and network access for executed code. Stdio MCP servers can be sandboxed independently. |
