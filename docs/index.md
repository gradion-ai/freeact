...
| **Subagent delegation** | Agents can [delegate subtasks](sdk.md#subagents) to child agents that run with their own kernel and context. Parent and child share the same event stream and [approval flow](sdk.md#approval). |
