...
| **Agent skills** | Freeact supports the [agentskills.io](https://agentskills.io/) specification - a lightweight format for extending agent capabilities with specialized knowledge and workflows. Freeact provides skills for saving code actions as tools, enhancing existing tools, and structured task planning. |
