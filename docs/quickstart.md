...
!!! tip "Using a different model"
    ...
    The current default model is `gemini-3-flash-preview`. Freeact supports any model compatible with Pydantic AI. To switch providers or configure model settings, see [Models](models.md).
